...
CREATE INDEX idx_smart_cheques_payer_id ON smart_cheques(payer_id);
CREATE INDEX idx_smart_cheques_payee_id ON smart_cheques(payee_id);
CREATE INDEX idx_smart_cheques_status ON smart_cheques(status);
CREATE INDEX idx_milestones_smart_cheque_id ON milestones(smart_cheque_id);
